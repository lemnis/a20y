 ...
 * @extends Base
 */
class AccessibleNode extends Base {
	constructor(...args) {
		super(...args);
		...
		this._.mutations.push(["role", "aria-activedescendant", "aria-atomic", "aria-autocomplete",
...
Object.defineProperties(AccessibleNode.prototype, 
	/** @lends AccessibleNode.prototype */
	{
		...
		*/
		...
		"activeDescendant": {
			enumerable: true,
			set(ay) { return setAccessibleNode(this, "aria-activedescendant", ay); },
		...
		"details": {
			enumerable: true,
			set(ay) { return setAccessibleNode(this, "aria-details", ay); },
		...
		"errorMessage": {
			enumerable: true,
			set(ay) { return setAccessibleNode(this, "aria-errormessage", ay); },
...
function setAccessibleNode(ay, attribute, an) {
	...
	if (!an.element.id) { throw new Error("Element must have an ID"); }
...
function getAccessibleNode(ay, attribute) {
	...
	return elements.get(ay.element.ownerDocument.getElementById(id));
}
